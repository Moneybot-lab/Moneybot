...
def create_app() -> Flask:
    ...
    app.config.update(
        ...
        DETERMINISTIC_QUICK_ABSTAIN_MARGIN=float(os.environ.get("DETERMINISTIC_QUICK_ABSTAIN_MARGIN", "0.05")),
    ...
    app.extensions["deterministic_quick_advisor"] = DeterministicQuickAdvisor(
        ...
        quick_abstain_margin=app.config["DETERMINISTIC_QUICK_ABSTAIN_MARGIN"],
